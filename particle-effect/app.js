...
function calcVelocity(ball) {
    ...
    ball.velocity.x += ball.movementX * ball.acceleration.x - ball.velocity.x * ball.deceleration.x;
    ball.velocity.y += ball.movementY * ball.acceleration.y - ball.velocity.y * ball.deceleration.y;
}
