...
class Mouse {
    ...
    optionsMouseoverHandler() {
        this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
    }
    optionsMouseleaveHandler() {}
}
...
class Player {
    constructor(x, y) {
        ...
        // stats
        this.mobileScreenSize = 600;
        this.health = 10;
        this.damage = 1;
        this.acc = window.innerWidth > this.mobileScreenSize ? 1 : 0.6;
        this.turnSpeed = window.innerWidth > this.mobileScreenSize ? 0.12 : 0.06;
        this.decel = 0.1;
        // color & style
        this.hue = 47;
        this.saturation = 100;
    ...
    initCanvases() {
        ...
        accInput.value = this.acc.toFixed(1);
        turnSpeedInput.value = this.turnSpeed.toFixed(2);
    }
    update() {
        const newAcc = accInput.value;
        const newturnSpeed = turnSpeedInput.value;
...
window.addEventListener('resize', () => {
    ...
    accInput.value = window.innerWidth > player.mobileScreenSize ? 1 : 0.6;
    turnSpeedInput.value = window.innerWidth > player.mobileScreenSize ? 0.12 : 0.06;
});
// Mouse Events
...
// Options Events
options.addEventListener('mouseover', () => mouse.optionsMouseoverHandler());
options.addEventListener('mouseleave', () => mouse.optionsMouseleaveHandler());
